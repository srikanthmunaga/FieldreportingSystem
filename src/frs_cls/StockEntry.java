...
public final class StockEntry extends HttpServlet {
...
//				String bsflunit_name = request.getParameter("unit_name");
				...
				String statid=sta_id.substring(sta_id.lastIndexOf("-")+1);
				System.out.println("stationary id is :"+statid);
				String sta_name = request.getParameter("sta_name");
				String dos = request.getParameter("date_os");
				String no_of_stock = request.getParameter("no_stock");
				String value_purchase = request.getParameter("v_purchase");
...
//					ps=con.prepareStatement("select unit_code from unit_msrt where ")
				    ps1= con.prepareStatement("insert into STOCK_ENTRY values(?,?,to_date(?,'dd-mm-rrrr'),?,?)");
//					ps1.setString(1,bsflunit_ucode.substring(0,3));
//					ps1.setString(2,bsflunit_name);
					ps1.setString(1,statid);
//					request.getSession().setAttribute("st_id",sta_id);
					ps1.setString(2,sta_name);
					ps1.setString(3,dos);
					ps1.setString(4,no_of_stock);
					ps1.setString(5,value_purchase);
...
//					ps1.setString(10,pre_by);
					...
					if(f!=0){  
			            ...
			            out.println("OKstock entry master for  " +statid+ " has been sucessfully Entered");  


			          }  
			          else{  
			            
			            out.println("stock entry master has not been placed for different reasons");
			           }  
...
//					}		
					...
					//}//count(*)>=12 else
						...
						out.println("stationary id doesnot exist");
