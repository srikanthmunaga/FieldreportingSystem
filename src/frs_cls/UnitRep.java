...
public class UnitRep extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (request.getSession().getAttribute("username") == null) {
			...
			String bsflunit_ucode1[] = request.getParameterValues("huma_id");

			System.out.println("report_name=" + report_name);
			// System.out.println("huma_id="+huma_id);
			UnitReports ur = new UnitReports();
			ur.FRSReports(request, response, fdate, tdate, format, report_name,
					bsflunit_ucode1);
