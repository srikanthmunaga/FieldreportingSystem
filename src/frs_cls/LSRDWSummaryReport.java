...
/**
 * Servlet implementation class LSRDWSummaryReport
 */
public class LSRDWSummaryReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String SUCCESS = null;
	private Connection con;  
    private Logger log = Logger.getLogger(LSRDWSummaryReport.class);
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LSRDWSummaryReport() {
        super();
	...
	{
		//System.out.println("inside the LSRDWSummaryReport class tested by Rajesh");		
		...
		try {
			...
			{*/
				...
				String huma_id=request.getSession().getAttribute("username").toString();
