...
public final class MultipleStock extends HttpServlet {

	   Connection con=null;
	   PreparedStatement ps=null;
	   PreparedStatement ps1=null,ps2=null,ps6=null;
	   ResultSet rs=null,rs2=null,rs6=null;
	   int f=0;
	   int g=0;
					...
					// request).getSession().getAttribute("user") != null)
			{
		       ...
		       String bsflunit_cdate=dd+"-"+mm+"-"+yyyy;
				...
				try {
					...
					ps6 = con.prepareStatement("select nvl((select distinct to_number(CONTROLNO+1) from stockindent where CONTROLNO=(select max(CONTROLNO) from stockindent)),1) as CONTROLNO from dual");
					rs6 = ps6.executeQuery();	
					rs6.next();
					String UHLOG_CONTROLENO=Integer.toString(rs6.getInt(1));
					System.out.println("valie is"+UHLOG_CONTROLENO);
