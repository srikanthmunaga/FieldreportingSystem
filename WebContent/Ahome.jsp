...
<body bottommargin="100%" marginheight="100%" rightmargin="100%"
   ...
   <!--<tr><td class="menu"><a href="HRStatus Master.jsp">HR Status Master</a></td></tr>-->
     ...
     <!--<tr><td class="menu"><a href="unittransfer.jsp">Unit Transfer</a></td></tr>-->
												...
												<td width="17%" onMouseOver="showmenu('Reports')"
													...
													<table class="menu" id="Reports" width="220" border="0"
														bordercolor="blue">
														<tr>
															<td class="menu"><a href="HrDetailedRep.jsp">HR Detailed Report</a></td>
														</tr>
														<!-- <tr>
															<td class="menu"><a href="HrSummaryAreaRep.jsp">Hr Area Summary Report</a></td>
														</tr>
														<tr>
														...
														<tr>
															<td class="menu"><a href="indentreport.jsp">Indent Report</a></td>
														</tr>
													</table>
												</td>
