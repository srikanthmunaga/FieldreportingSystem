...
<form name="auto"  action="SMStoODCustomer" method="post">

<table bgcolor="" width="100%" height="91%" border="0"
							align="center" bordercolor="#000000">
							<tr align="center">
								<td colspan="3" align="center"><img alt="" src="images/loading-bars.gif"></td></tr>
							<tr align="center">
								<td colspan="3" align="center">
								
								<font color="red" size="3"><b>Please wait, SMS sending to OD Customers is under process....! </b></font>
								</td></tr></table>
</form>
