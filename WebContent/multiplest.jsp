...
//---------------add function for inner dynamic filds 
		...
		var par=this.parentNode; 
	 	...
	 	($(this).parent()).append('<input type="text" name="textbox'+rowindex+'" id="textbox'+rowindex+'" size="18" onkeyup="allowupdate();" style="border-color:#0099FF;" maxlength="65"  onfocus="addSuggestion2(\'st_id\',\'textbox'+rowindex+'\',st_id.value);">');
	 	//counter++;
	     });
...
<p align="right">
 <table width="1150" align="center">
  ...
  <fieldset style="background-color:">
	<legend class="formTitle"><b> WAR Room Weekly Plan</b> </legend>
    ...
    <tr>
      ...
      <tr>      
      <td width="" height="" align="right" style=""><div align="right">Stationary Id</div></td>
     <td>
 	<div id="TextBoxesGroup" align="left">							   
	<input type="button" value="+" id="addButton" name="addButton" class="addDynTextBox"></div></td>
     </tr>
     </td>
                ...
                <table id="msg2" style="visibility:hidden; position:absolute;" align="">
                  ...
                  <td   width="" align="left" >&nbsp;&nbsp;
                    <input type="button" id="exct" name="exct" class="groovybutton" value="&euro;"    title="" onmouseover="goLite(this.form.name,this.name); showmenu('msg');"
   						onmouseout="goDim(this.form.name,this.name); hidemenu('msg');" onclick="showEmpn('war_target',BSFLUNIT_UCODE.value,huma_id.value,war_date.value);"/>
