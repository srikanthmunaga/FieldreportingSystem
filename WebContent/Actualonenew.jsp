 ...
 <table width="1150" align="center">
  ...
  <fieldset style="background-color:">
    ...
    <tr>
      ...
      <tr> <td width="" height=""><div align="right">Region</div></td>
              ...
              <table id="tableID" width="100%" style="border:1px solid #708090;;width: 100%" ><!--  -->
                  ...
                  <!-- <tr bgcolor="back03.gif" style="opacity: 0.65; filter: alpha(opacity=65);"> -->
                   <!--  <th width="1%" scope="col" class="style21" bgcolor="#E6E6FA" style="height: 16px;"><div align="center">Sno</div></th> -->
                    ...
                    <th width="10%" scope="col" class="style21" bgcolor="#E6E6FA" style="height: 16px;"><div align="center">Visited With</div></th>
					...
					<!-- <th width="16%" class="style21" scope="col" bgcolor="#E6E6FA" style="height: 16px; width: 164px"><div align="center">Night Stay At Unit(Yes/No)</div></th> -->
...
<td style="" valign="top"><div align="center">
				...
				<select name="act_id" id="act_id"  size="0" 
												onChange="allowupdate(); showEmps1('act_name',this,this.value);">
...
<!--<td><div align="center"><input name="lsrname" type="text" id="lsrname"  style="border-color:#0099FF; width:95%" onkeyup="allowupdate();" onfocus="addSuggestion('lsrname','lsrname');"maxlength="57"  /></div></td>
 ...
 --> 					<!-- <td><div align="center"><input name="ACTIVITY_ID" type="text" id="ACTIVITY_ID"  style="border-color:#0099FF; width:95%" onkeyup="allowupdate();" maxlength="57" onfocus="showEmpn2('lsrname.ACTIVITY_ID',this,this.value);"/></div></td> -->
					...
					<td valign="top"><div align="center"><input name="visited_with" type="text" id="visited_with" style="width:90%" size="10" onkeyup="allowupdate();" onfocus="addSuggestion2('NAME','name_visited',BSFLUNIT_UCODE.value);" maxlength="10"/></div></td>
