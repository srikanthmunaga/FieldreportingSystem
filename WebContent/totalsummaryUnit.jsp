...
{//alert("inside the validation and"); //onSubmit="validateForm()" 
 ...
 //fdate validation
   ...
   if(!date.test(document.form1.huma_id.value))
   {
...
//alert("End of validateForm() function");
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			...
			<tr valign="top">
				<td>
					<!-- <form id="form1" name="form1" action="totalsummary" method="post" onSubmit="return validateForm();"> -->
					<form id="form1" name="form1" action="totalsummaryUnit"
						...
						<center>
							<table>
								...
								<tr>
									...
									<td></td>
									<td></td>
									<td><input type="submit" name="op"
										value="Generate XLS Report" onmouseover="goLite2(this);" onmouseout="goDim2(this);"/></td>
									<!-- <td><input type="submit" name="op" value="Generate PDF Report"/></td> -->
								</tr>
							</table>
						</center>
					</form>
