   ...
   <tr><td class="menu"><a href="issuedstock.jsp">Issued Stock</a></td></tr>
												...
												<td width="17%" onMouseOver="showmenu('Reports')"
													...
													<table class="menu" id="Reports" width="220" border="0"
														bordercolor="blue">
   <tr><td class="menu"  ><a href="Unitindentrep.jsp" >Unit Indent Report</a></td></tr>
   <tr><td class="menu"  ><a href="Stationaryindentrep.jsp" >Stationary Indent Report</a></td></tr>
...
<font class="style22">Log type </font>
  ...
  <tr height="">
   ...
   onmouseout="goDim(this.form.name,this.name)" onclick="window.location='Ahome.jsp'"/>
          &nbsp;&nbsp;&nbsp;<br />
