				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">HR Detailed Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<input type="submit" name="format"
										...
										<input type="button" id="cancel" name="cancel" class="groovybutton" value="Cancel" title="" onmouseover="goLite(this.form.name,this.name)"   onmouseout="goDim(this.form.name,this.name)" onclick="window.location='Ahome.jsp'"/>
										</td>
    ...
    con= dbConn.getConnection();
	  ...
	  { if(rs.next())//query to get all employees information,just like superuser
	    ...
	    */
		...
		if((role.equals("admin"))||(role.equals("audit")))// || role.equals("areahead") || role.equals("unithead"))
		ps2 = con.prepareStatement("select distinct BSFLUNIT_UCODE ,BSFLUNIT_NAME, to_char(date_of_cou,'dd-mm-yyyy'),row_number() over(order by BSFLUNIT_UCODE) as sno from ISSUE_INDENT");
