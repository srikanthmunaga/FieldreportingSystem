...
<!-- 						<fieldset style="background-color:">
 ...
 -->							<table bgcolor="" width="100%" height="91%" border="0"
								...
								%>
								<td class="style23"><font color="blue"><b>
								<%=ses.getAttribute("total")%> &nbsp;&nbsp; SMS's was sent successfuly..! </b></font>
								</td></tr><tr>
								<td  align="right"><a href="SMStoODCustomer.jsp"><font color="Blue"><b>BACK</b></font></a></td>
					</tr>
					</table>
<!-- 						</fieldset> -->
					</td> 
