				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">Work Plan Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<input type="submit" name="format"
										...
										id="report_name" value="HrSummaryRep" />
										<input type="submit" name="format"
										value="Generate XLS Report" onMouseOver="goLite2(this);" onMouseOut="goDim2(this);"/>
										<input type="hidden" name="report_name2"
										id="report_name2" value="HrSummaryRep" />
										<input type="button" id="cancel" name="cancel" class="groovybutton" value="Cancel" title="" onmouseover="goLite(this.form.name,this.name)"   onmouseout="goDim(this.form.name,this.name)" onclick="window.location='Mhome.jsp'"/>
										</td>
	  ...
	  { if(rs.next())//query to get all employees information,just like superuser
	   ...
	   %>
                <tr bgcolor="silver">
                  ...
                  <th scope="col" ><div align="center" >Activity Category</div></th>
                  <th scope="col" ><div align="center" >Activity Name </div></th>
