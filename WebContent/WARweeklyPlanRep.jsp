...
<title>WAR Room Weekly Plan Report</title>
<% 
				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							<!-- <legend class="style23">Area Master</legend> -->
							<legend class="formTitle">WAR Room Weekly Plan Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<td><input type="hidden" name="report_name"
										id="report_name" value="WARweeklyPlanRep" /></td>
