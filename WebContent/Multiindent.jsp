...
for(var x5=1; x5<l; x5++)
 ...
 alert(document.getElementById("bsflunit_ucode").value =star[x][1]);
							...
							<tr>
								...
								<td width="76%" align="left"><div align="left">
										...
										<input name="bsflunit_ucode" id="bsflunit_ucode" type="text" size="35"
											...
											onBlur="showEmp('unit_id.area_id.comp_id',unit_id.value,'');"/><input type="hidden" name="UHLOG_CONTROLENO2" id="UHLOG_CONTROLENO2"></input>
											</div></td>
							</tr>
							<tr>
