...
<title>Upload Unit Actual PODs</title>
<% 
...
<form id="form1" name="form1" method="post" action="targetpod_pw" enctype="multipart/form-data" onSubmit="return validate();">
<br />
<p align="right">
 <table width="50%" align="center">
  ...
  <fieldset style="background-color:">
	<legend class="formTitle"><b> Upload Unit Actual PODs</b> </legend>
<br />
...
<input type="submit" id="generate" name="generate"
  ...
  <a href="images/PODsample.csv" class="dislpayLabel" >See Sample format, CSV file</a>	
  </div> </fieldset> 
</table>
