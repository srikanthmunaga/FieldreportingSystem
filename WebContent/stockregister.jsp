				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">Unit Indent Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<input type="submit" name="format"
										...
										id="report_name" value="indentreport" />
										<input type="submit" name="format"
    ...
    con= dbConn.getConnection();
	  ...
	  { if(rs.next())//query to get all employees information,just like superuser
	    ...
	    */
		...
		if((role.equals("admin"))||(role.equals("audit")))// || role.equals("areahead") || role.equals("unithead"))
		ps2 = con.prepareStatement("select S_ID,S_NAME,TO_CHAR(DATE_OF_STOCK,'DD-MM-YYYY'),NO_OF_STOCK,VALUE_OF_PURCHASE,row_number() over(order by DATE_OF_STOCK) as sno from STOCK_ENTRY");
	   ...
	   %>
                <tr bgcolor="silver">
                  ...
                  <th scope="col" ><div align="center" >DATE OF STOCK </div></th>
                  <th scope="col" ><div align="center" >No Of Stock </div></th>
                  <th scope="col" ><div align="center" >Value Of Purchase </div></th>
