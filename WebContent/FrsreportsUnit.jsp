...
<title>FRS Reports HomePage</title>
<% 
...
<link href="styles/basix_styles.css" rel="stylesheet" type="text/css" />
					...
					<form id="form1" name="form1" action="">
						...
						<center>
							...
							<table width="500" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td><table width="80%" align="center" cellpadding="5"
											cellspacing="5">
											...
											<tr>
												<td><table width="100%" border="0" cellpadding="0"
														...
														<tr>
															...
															<!-- <td width="94%" align="center"><a href="totalsummarymonth.jsp">Day Wise Summary Reports</a></td> -->
															<td width="94%" align="center"><a
																href="totalsummarymonthUnit.jsp">Day Wise Summary
																	Reports</a></td>
												...
												<td><table width="100%" border="0" cellpadding="0"
														...
														<tr>
															<td width="3%"><img
																src="images/home_linktab_left.jpg" width="100%"
																height="35" alt="Home links" /></td>
															<!-- <td width="94%" align="center"><a href="totalsummary.jsp">LSR wise Summary Report</a></td> -->
															<td width="94%" align="center"><a
																href="totalsummaryUnit.jsp">LSR wise Summary Report</a></td>
															<td width="3%" align="right"><img
																src="images/home_linktab_right.jpg" width="10"
																height="35" alt="Home links" /></td>
														</tr>
											...
											<!-- 
                              <tr>
                                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="homelinksTab">
                                  <tr>
                                    <td width="3%"><img src="images/home_linktab_left.jpg" width="100%" height="35" alt="Home links" /></td>
                                    <td width="94%" align="center"><a href="unitsummary.jsp">Total Unit's Summary Report</a></td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td width="3%"><img src="images/home_linktab_left.jpg" width="100%" height="35" alt="Home links" /></td>
                                    <td width="94%" align="center"><a href="Lsasummary.jsp">Total LSR's Summary Report</a></td>
                                    <td width="3%" align="right"><img src="images/home_linktab_right.jpg" width="10" height="35" alt="Home links" /></td>
                                    </tr>
                                  </table>
                                  </td>
 ...
 -->
                                  ...
                                  <tr>
                                    <td width="3%"><img src="images/home_linktab_left.jpg" width="100%" height="35" alt="Home links" /></td>
                                    <td width="94%" align="center"><a href="unitmonthsummary.jsp">Unit Wise summary Reports Monthwise</a></td>
                                    <td width="3%" align="right"><img src="images/home_linktab_right.jpg" width="10" height="35" alt="Home links" /></td>
                                    </tr>
                                  </table>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td width="3%"><img src="images/home_linktab_left.jpg" width="100%" height="35" alt="Home links" /></td>
                                    <td width="94%" align="center"><a href="lsrmonthsummary.jsp">LSR Wise summary Reports Monthwise</a></td>
                                    <td width="3%" align="right"><img src="images/home_linktab_right.jpg" width="10" height="35" alt="Home links" /></td>
                                    </tr>
                                  </table>
                                  </td>
