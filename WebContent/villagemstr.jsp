...
<title>BSFL Village master</title>
...
function validateForm()
{
   ...
   if(patt12.test(document.form1.vcode.value))
	  {
       alert("Please enter the Unit code,Correctly");
	   document.form1.vcode.focus();
       return false;
	 ...
	 if((!patt2.test(document.form1.vname.value))||(reason.test(document.form1.vname.value))|| (document.form1.vname.value.length<4))
    {
	 ...
	 if(!patt10.test(document.getElementsByName("unit")[0].value))   
		{
		  alert("Please enter the value for Area Belongs To");
		  document.getElementsByName("unit")[0].focus();
		  document.getElementsByName("unit")[0].style.background="#fffacd";
		  return false;
		}
	 
	 if(!patt10.test(document.getElementsByName("district")[0].value))   
	{
	  alert("Please enter the value for Unit incharge");
	  document.getElementsByName("district")[0].focus();
	  document.getElementsByName("district")[0].style.background="#fffacd";
	  return false;
	}
...
{ 
  ...
  { 
   ...
   document.form1.vcode.disabled=false;
   document.form1.vname.disabled=false;
   document.form1.unit.disabled=false;
 ...
 document.getElementById("vcode").value =star[x][0];
 document.getElementById("vname").value =star[x][1];
 document.getElementById("unit").value =star[x][2];
...
//Everything from disable() exceptiong button code,just for primary key enable(replace true by false) and editable(add readOnly=false)
 document.form1.vcode.value='';
 document.form1.vname.disabled=true;
 document.form1.vcode.disabled=false;//because we allow the user to query using his own value//new code from this line
 document.form1.vcode.readOnly =false;//because it was made readOnly (after retrieving the records),allows to enter
//--------------------------------------Common (buttons) code
...
function disable() 
{
 ...
 document.form1.vcode.value='';
 document.form1.vcode.disabled=true;
 
 document.form1.vname.value='';
 document.form1.vname.disabled=true;
 
 document.form1.district.value='';
 ...
 document.form1.unit.disabled=true;
  //---------common (button) code
		...
		<table width="604" height="" align="center">
			<tr>
				<td width="570"><fieldset style="background-color:">
						<legend class="formTitle">BSFL Village master </legend>
								...
								<td><table width="100%" border="0" bgcolor="">
										...
										<tr>
											...
											<td><div align="left">
													<input name="vcode" type="text" id="vcode"
														...
														onfocus="addSuggestion('vcode','vcode');"
														onkeyup="allowupdate();" class="masterInput" />
												</div></td>
										</tr>
										<tr>
											...
											<td><div align="left">
													<input name="vname" type="text" id="vname"
														size="25" maxlength="35" onKeyUp="allowupdate();" />
												</div></td>
										</tr>
										...
										<tr>
											...
											<td><div align="left">
													...
													<input type="text" name="unit" id="unit" maxlength="30"
														size="30" onKeyUp="allowupdate();"
														onfocus="addSuggestion('unit','unit');"
														class="masterInput" />
												</div></td>
										</tr>
										...
										<tr>
											...
											<!-- <td><div align="left">
												...
												<td><div align="left">
													...
													<input type="text" name="district" id="district" maxlength="30"
														size="30" onkeyup="allowupdate();"
														onfocus="addSuggestion('unithead','district');"
								...
								<td align="center" height=""><table>
										<tr>
											...
											<td width="" align="left">&nbsp;&nbsp; <input
												...
												onclick="showEmpn('BSFLUNIT_MSTR',vcode.value,'');" /> <br />
												<table id="msg"
													style="visibility: hidden; position: absolute;" align="">
													<tr>
														<td>Execute</td>
