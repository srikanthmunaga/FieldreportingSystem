...
<title>Field Staff Day wise Target Vs Achievement Rep</title>
<% 
				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">Field Staff Day wise Target Vs Achievement Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<td><input type="hidden" name="report_name"
										id="report_name" value="TargetVsAchievementRep" /></td>
