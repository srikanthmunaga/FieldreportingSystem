...
<title>Field Staff Recovery Entry</title>
<% 
...
<td>
 ...
 <input type="text" name="huma_id" onfocus="addSuggestion('huma_id_recovery','huma_id');" class="masterInput"/>
...
Sorry,NO Rights to Enter the Details
</div>
