...
<title>WAR Room HO Report</title>
<% 
				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">WAR Room HO Report</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									...
									<td><input type="hidden" name="report_name"
										id="report_name" value="WARHORep" onMouseOver="goLite2(this);" onMouseOut="goDim2(this);"/></td>
