...
<body bottommargin="100%" marginheight="100%" rightmargin="100%"
		...
		<tbody>
			...
			<tr valign="top">
				<td>
					...
					<form id="form1" name="form1" action="montotsummaryUnit"
						method="post">
						<table cellpadding="1" cellspacing="1" background="blue">
							<tr>
								<td width="330" align="right"><b><a
										href="FrsreportsUnit.jsp">REPORTS HOME</a></b></td>
 ...
 <td><input type="radio" name="dwr" id="unit" value="Unit" onclick="return r3();"/>Unit</td>
 <td><input type="radio" name="dwr" id="lsr" value="lsr" onclick="return r2();"/>LSR</td>
 -->
								</tr>
								...
								<tr>
									...
									<td align="right"><label id="area_name2">Region Name
											<!--  <input type="text" name="area_name" id="area_name" align="right" onfocus="addSuggestion('area_name','area_name');" class="masterInput">   -->
...
<td></td>
 ...
 -->
								...
								<tr>
									<td></td>
									<td><input type="submit" value="Generate XLS Report"
