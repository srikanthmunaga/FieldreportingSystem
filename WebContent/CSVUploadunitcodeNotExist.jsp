...
<form id="form1" name="form1" method="post" action="">
					...
					<h4 align="center">
						<font color="blue"> Actual PODs uploaded Successfully., but<br>Below Unit Code's Does not exist, Please check and you can upload total sheet again.</font>
					</h4><br /><div align="center"><%=NonExist_EmpList%><br /><br /><input type="button" id="idname" value = "Back" onclick="javascript:window.location.href='target%20pod.jsp';"/><br>
							   </div>
