...
<!--						<table cellpadding="1" cellspacing="1" background="blue">
				...
				<tr>
					<td height="">
						<fieldset style="background-color:">
							...
							<legend class="formTitle">Isssue Indent Master</legend>
    ...
    con= dbConn.getConnection();
	   ...
	   // String role=request.getSession().getAttribute("userrole").toString();
		...
		if((role.equals("admin"))||(role.equals("audit")))// || role.equals("areahead") || role.equals("unithead"))
		ps2 = con.prepareStatement("select bsflunit_ucode,bsflunit_name, s_id,s_name,to_char(date_of_indent,'dd-mm-yyyy'),new_stock,in_by,row_number() over(order by date_of_indent) as sno from stockindent where status='N'");
	   ...
	   %>
                <tr bgcolor="silver">
                  ...
                  <th scope="col" ><div align="center" >Requested Quantity</div></th>
                  <th scope="col" ><div align="center" >Indent By</div></th>
                  <th scope="col" ><div align="left" >Issue Indent</div></th>
                </tr>
                <%
	  while(rs2.next())
		{
		  %>
                <tr>
                  <td><div align="center"><%=rs2.getString(8)%>&nbsp;</div></td>
                  ...
                  <td><div align="left">
                    <a href="<%=request.getContextPath()%>/Issue?id=<%=(rs2.getString(1))%>&id2=<%=rs2.getString(3) %>" style="color:blue">Click here to Issue Indent</a> 
                  </div></td>
