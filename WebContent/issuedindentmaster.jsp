...
<title>Issue Indent Master</title>
...
{ //alert("hey inside the validateForm() function");
   ...
   var couid=document.form1.courier_id.value;
   if(couid==""){
	   alert("please enter the courier id");
	   document.form1.courier_id.focus();
	   return false;
   }
   var couname=document.form1.courier_name.value;
   if(couname==""){
	   alert("please enter the courier name correctly");
	   document.form1.courier_name.focus();
	   return false;
   }
...
{ 
  ...
  document.getElementById("last_issued").value =star[x][2];
  document.getElementById("closing_stock").value =star[x][3];
  document.getElementById("available_stock").value =star[x][4];
  document.getElementById("issue_stock").value =star[x][5];
  document.getElementById("date_is").value =star[x][6];
  document.getElementById("courier_id").value =star[x][7];
  document.getElementById("courier_name").value =star[x][8];
 }//show()
...
//if it was made editable in queryfunction
...
<!---------------- Code for FRS menu.js starts here  ------------------------->
   ...
   <tr><td class="menu"><a href="stationarymaster.jsp">Stationary master</a></td></tr>
    <tr><td class="menu"><a href="unitindentmaster.jsp">Unit indent master</a></td></tr>
    <tr><td class="menu"><a href="stockentry.jsp">Stock entry master</a></td></tr>
     <tr><td class="menu"><a href="issue1.jsp">Issued Indent master</a></td></tr>
				...
				<tr>
					<td width="606" height="250">
						<fieldset style="background-color:">
							<legend class="formTitle"> Issue Indent Master</legend>
							<table bgcolor="" width="100%" height="91%" border="0"
								...
								<tr>
									<td width="24%" align="right"><div
											align="right">Unit code</div></td>
									<td><div align="left">
													<input name="bsflunit_ucode" type="text" id="bsflunit_ucode"
														size="30" maxlength="35" value="<%=request.getSession().getAttribute("unit_id") %>" readonly="readonly"
													style="border-color: #0099FF;"/>
												</div></td>
								</tr>
								<tr>
									<td height="24" align="right"><div
											align="right" >Unit name</div></td>
									<td align="left">
										<div align="left">
											<input name="unit_name" id="unit_name" type="text" size="30"
												maxlength="35" value="<%=request.getAttribute("unit_name") %>" readonly="readonly"/>
										</div>
									</td>
								</tr>
								<tr>
												<td width="24%" align="right"><div align="right">Stationary
														Id</div></td>
												<td><div align="left">
													<input name="st_id" type="text" id="st_id"
														size="30" maxlength="35"
														value="<%=request.getAttribute("st_id") %>" readonly="readonly"														
														style="border-color: #0099FF;"/>
												</div></td>
											</tr>
								<tr>
								...
								<tr>
									<td height="24" align="right"><div
											align="right" >Last issued stock to Unit</div></td>
									<td align="left">
										<div align="left">
											<input name="last_issued" id="last_issued" type="text" size="20"
								...
								<tr>
									<td height="24" align="right"><div
											align="right" >Closing stock at Unit</div></td>
									<td align="left">
										<div align="left">
											<input name="closing_stock" id="closing_stock" type="text" size="20"
												maxlength="20" readonly=""
												/>
										</div>
									</td>
								...
								<tr>
									<td height="24" align="right"><div
											align="right" >Available stock with Unit</div></td>
									<td align="left">
										<div align="left">
											<input name="available_stock" id="available_stock" type="text" size="20"
												maxlength="20" readonly="" 
												/>
										</div>
									</td>
								...
								<tr>
									<td height="24" align="right"><div
											align="right" >Issuing stock to Unit</div></td>
									<td align="left">
										<div align="left">
											<input name="issue_stock" id="issue_stock" type="text" size="20"
												maxlength="20"   />
										</div>
									</td>
								</tr>
								...
								<td height="25" class="style22" align="right"><div
										align="right">Date of issued</div></td>
								<td align="left"><div align="left">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="27%">
													<div align="left">
														<input type="text" name="date_is" id="date_is" size="10"
															maxlength="10" onKeyUp="allowupdate();" /> <a href="#"
															onclick="setYears(1947, 2050);
       showCalender(this, 'date_is');">
							...
							<tr>
									<td height="24" align="right"><div
											align="right" >Courier Id</div></td>
									<td align="left">
										<div align="left">
											<input name="courier_id" id="courier_id" type="text" size="30"
												maxlength="35" 
												  />
										</div>
									</td>
								...
								<tr>
									<td height="24" align="right"><div
											align="right" >Courier name</div></td>
									<td align="left">
										<div align="left">
											<input name="courier_name" id="courier_name" type="text" size="30"
												maxlength="35" 
												  />
										</div>
									</td>
											...
											<td><script type="text/javascript" src="JS/Bbuttons.js"></script>
												...
												<table id="msg2"
													...
													<td width="" align="left">&nbsp;&nbsp; <input
														...
														onclick="showEmpn('issue_indent',bsflunit_ucode.value,'');" /> <br />
														<table id="msg"
...
Sorry,NO Rights to issue a Indent
</div>
