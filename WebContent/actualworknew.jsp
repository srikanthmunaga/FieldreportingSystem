...
alert("Cat length = "+cat); */
 var par=obj.parentNode;
 alert("the nodename is"+par);

 while(par.nodeName.toLowerCase()!='tr'){   par=par.parentNode;  } 
 //alert("the index of the current row is"+par.rowIndex); 
 var i=par.rowIndex;
 alert("the rowindex is "+1);
 j=i-1;
 alert("the row is"+j);
 //alert("J = "+j);
			...
			for(var x=0;x<=f;x++){
				...
				alert("Cate = "+cate);
				if(document.getElementsByName('act_id')[x].value == "006")
					{
					alert("Field Visit Selected");
					document.getElementsByName('unit_visited')[x].style.visibility='visible';
					}
...
for(var x5=1; x5<l; x5++)
 ...
 var war_withuh=document.getElementsByName('withuh');
 var war_stay1=document.getElementsByName('stay');
...
// var war_sdrcust_count_opted = document.getElementsByName('war_sdrcust_count_opted');
 ...
 //alert("hinsiede the for loop,and the  head="+star[k][2]+"--");
  ...
  war_day[j].value=star[k][11];
  // village1[j].value=star[k][7];
  war_cust_count[j].value=star[k][6];
  war_sdrcust_count[j].value=star[k][7];
  war_withuh[j].value=star[k][5];
  war_stay1[j].value=star[k][8];
  war_obs[j].value=star[k][9];
 }
  
  //war_sdrcust_count_opted[j].value=star[k][7];
  //alert("star[k][8]="+star[k][8])
  var villages=star[k][10].split("::");
...
<script type="text/javascript" src="JS/jquery.table.addrow.js"></script> 
   ...
   <tr><td class="menu"><a href="activitymaster1.jsp">Activity Master</a></td></tr>
   ...
   <tr><td class="menu"><a href="actualworknew.jsp">Actual Work Done</a></td></tr>
            ...
            <td colspan="4" height="100%" valign="top" align="center"><div align="left"><b> <!--WAR Room Data  Entry--></b></div>
              <table id="tableID" width="100%" style="border:1px solid #708090;;width: 100%" ><!--  -->
                  ...
                  <!-- <tr bgcolor="back03.gif" style="opacity: 0.65; filter: alpha(opacity=65);"> -->
                    ...
                    <th width="10%" scope="col" class="style21" bgcolor="#E6E6FA" style="height: 16px;"><div align="center">Activity </div></th>
...
<td style="" valign="top"><div align="center">
 ...
 rs = stmt.executeQuery("select act_id,act_name from statehead_activities");  
   while(rs.next()){
...
<td valign="top"><div align="center"><input name="unit_visited"  type="text"   id="unit_visited"  style="width:90%" size="10" onkeyup="allowupdate();" maxlength="10" onfocus="addSuggestion('BSFLUNIT_UCODE_roles','unit_visited');"/></div></td>
...
<!--<td><div align="center"><input name="lsrname" type="text" id="lsrname"  style="border-color:#0099FF; width:95%" onkeyup="allowupdate();" onfocus="addSuggestion('lsrname','lsrname');"maxlength="57"  /></div></td>
 ...
 --> 					<!-- <td><div align="center"><input name="ACTIVITY_ID" type="text" id="ACTIVITY_ID"  style="border-color:#0099FF; width:95%" onkeyup="allowupdate();" maxlength="57" onfocus="showEmpn2('lsrname.ACTIVITY_ID',this,this.value);"/></div></td> -->
					...
					<td valign="top"><div align="center"><input name="visited_with" type="text" id="visited_with" style="width:90%" size="10" onkeyup="allowupdate();" onfocus="addSuggestion2('NAME','visited_with',BSFLUNIT_UCODE.value);" maxlength="10"/></div></td>
					...
					<td ><div align="center"><textarea name="observations" id="observations" style="width:95%" rows="4" onkeyup="EnforceMaximumLength(this,300); allowupdate();" onblur="EnforceMaximumLength(this,300);"></textarea></div></td>
                ...
                <table id="msg2" style="visibility:hidden; position:absolute;" align="">
                  ...
                  <td   width="" align="left" >&nbsp;&nbsp;
                    <input type="button" id="exct" name="exct" class="groovybutton" value="&euro;"    title="" onmouseover="goLite(this.form.name,this.name); showmenu('msg');"
   						onmouseout="goDim(this.form.name,this.name); hidemenu('msg');" onclick="showEmpn('actual_plan',BSFLUNIT_UCODE.value,huma_id.value,war_date.value);"/>
