...
<p align="right">
 <table width="1200" align="center">
  ...
  <fieldset style="background-color:">
	<legend class="formTitle">UH Activity Entry </legend>
    ...
    <tr>
      ...
      <!--  <td width="" align="left"><div align="left"><input name="BSFLUNIT_UCODE" id="BSFLUNIT_UCODE" type="text"  style="border-color:#0099FF; size="20" onfocus="addSuggestion('BSFLUNIT_UCODE','BSFLUNIT_UCODE');" onblur="showEmp('BSFLUNIT_NAME.area_name',BSFLUNIT_UCODE.value,'');"/><input type="hidden" name="UHLOG_CONTROLENO2" id="UHLOG_CONTROLENO2"></input></div></td> -->
      ...
      <td width=""><div align="right">Date</div></td><td width="" align="left">
      <table width="" border="0" cellspacing="0" cellpadding="0" align="left">
      		<tr><td width="130px" align="left"><input type="text" name="UHLOG_DATE" id="UHLOG_DATE" size="10" maxlength="10" onkeyup="allowupdate();" />
           		<a href="#"  onclick="setYears(1947, 2050);
       showCalender(this, 'UHLOG_DATE');"> <img id="cal1"  src="images/calender.png" onclick="allowupdate();"/></a></div></td>
           		<td width="">(dd-mm-yyyy)<br /></td>
		    </tr>
      </table>
    ...
    <tr>
            <td colspan="4" height="100%" valign="top" align="center"><div align="left"><b>Customer Connect Activities</b></div>
              <table id="tableID" width="100%"  border="1" style="border-style:outset; border-color:blue" ><!--  -->
                  ...
                  <!-- <tr bgcolor="back03.gif" style="opacity: 0.65; filter: alpha(opacity=65);"> -->
                    ...
                    <th width="6%" scope="col" class="style21"><div align="center">Vcode</div></th>
                    <th width="10%" scope="col" class="style21"><div align="center">Activity Category</div></th>
                    <th width="10%" scope="col" class="style21"><div align="center">Activity</div></th>
...
<%--                     <td><div align="center">
 ...
 --%>               <td><div align="center"><input name="VCODE" type="text" id="VCODE"  style="border-color:#0088FF; width:95%" onkeyup="allowupdate();" maxlength="57" onfocus="addSuggestion2('VCODE','VCODE',BSFLUNIT_UCODE.value);"/></div></td>
                ...
                <table id="msg2" style="visibility:hidden; position:absolute;" align="">
                  ...
                  <td   width="" align="left" >&nbsp;&nbsp;
                    <input type="button" id="exct" name="exct" class="groovybutton" value="&euro;"    title="" onmouseover="goLite(this.form.name,this.name); showmenu('msg');"
  						 onmouseout="goDim(this.form.name,this.name); hidemenu('msg');" onclick="showEmpn('UHLOG_SERVICE',BSFLUNIT_UCODE.value,UHLOG_DATE.value,'');"/>
...
Sorry,NO Rights to do UH Activity Entry
</div>
