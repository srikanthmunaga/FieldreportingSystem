...
<title>Field Staff Details Update</title>
<% 
...
<form id="form1" name="form1" method="post" action="modifylsrdetails" onsubmit="return validate();">
						...
						<table align="center">
							...
							<tr>
								...
								<td><input type="text" name="FRS_SDRCUST_COUNT" 
								id="FRS_SDRCUST_COUNT" value="<%=session.getAttribute("sdr")%>"/></td>
							</tr>
